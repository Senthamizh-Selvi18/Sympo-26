...
const Contact = () => {
  ...
  const CoordinatorCard = ({ coordinator }) => (
    <div className="coord-card-outer">
      <div className="coord-flip-inner">
        {/* FRONT FACE */}
        <div className="coord-face coord-face-front">
          <div className="coord-border">
            <div className="coord-card">
              ...
              <span className="coord-flip-hint">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h5M20 20v-5h-5M4.5 9a8 8 0 0 1 14.6-3M19.5 15a8 8 0 0 1-14.6 3" />
                </svg>
                Hover for number
              </span>
        ...
        {/* BACK FACE */}
        <div className="coord-face coord-face-back">
          <div className="coord-border">
            <div className="coord-card coord-card-back">
              <span className="coord-tab coord-tab-tl" />
              <span className="coord-tab coord-tab-tr" />
              <span className="coord-tab coord-tab-bl" />
              <span className="coord-tab coord-tab-br" />

              <div className="coord-back-icon">
                <svg
              ...
              <p className="coord-back-label">Reach out to</p>
              <h3 className="coord-back-name">{coordinator.name}</h3>

              <div className="coord-back-number">{coordinator.phone}</div>
